...
export const heroImages = {
  main: {
    local: publicAsset("/images/hero/job-site.jpg"),
    fallback:
  ...
  accentA: {
    local: publicAsset("/images/hero/truck.jpg"),
    fallback:
      "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=800&q=80",
    alt: "SP Construction Group truck at a job site",
  },
  accentB: {
    local: publicAsset("/images/hero/framing.jpg"),
    fallback:
...
export const teamImages = {
  sam: {
    local: publicAsset("/images/team/sam-patel.jpg"),
    fallback:
  ...
  crew: {
    local: publicAsset("/images/team/crew.jpg"),
    fallback:
...
export const galleryImages = [
  {
    local: publicAsset("/images/gallery/01-home-exterior.jpg"),
    fallback:
  ...
  {
    local: publicAsset("/images/gallery/02-kitchen.jpg"),
    fallback:
  ...
  {
    local: publicAsset("/images/gallery/03-commercial.jpg"),
    fallback:
  ...
  {
    local: publicAsset("/images/gallery/04-framing.jpg"),
    fallback:
  ...
  {
    local: publicAsset("/images/gallery/05-bath.jpg"),
    fallback:
  ...
  {
    local: publicAsset("/images/gallery/06-site.jpg"),
    fallback:
